  ...
  array.forEach((item) => {
    ...
    <div class="card" style="width: 18rem;">
      <div class="card-body">
        ...
        <p class="card-text bold">${item.favorite ? '<span class="heart heart-icon heart-grin"><i class="fa-solid fa-face-grin-hearts"></i> Favorite</span>' : '<span><button id="favorite-author-btn">Do you love this?</button></span>'}</p>
        <hr>
